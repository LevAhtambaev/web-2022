...
export function Car(props: CarProps) {
    ...
    return (
        <div
            ...
            className="border py-0 px-0 rounded mb-2 grid grid-rows-4 grid-cols-6"
        >
            ...
            {ShowDescription && <div className="col-span-3">
                <p className="place-self-center text-lg">{props.car.Description}</p>
            </div>}
