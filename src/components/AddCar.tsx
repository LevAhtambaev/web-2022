...
import {AddingCar} from "../requests/AddCar";
...
export function AddCar() {
    ...
    const [wheel, setWheel] = useState('Правый руль');
        ...
        <>
            ...
            <div className="mt-10 sm:mt-0">
                <div className="md:gap-6">
                    <div className="px-4 ">
                            <h3 className="text-3xl mt-2 text-center font-medium leading-6 text-gray-900">Добавление новой машины</h3>
                    </div>
                        ...
                        <form>
                            <div className="overflow-hidden shadow sm:rounded-md">
                                ...
                                <div className="bg-gray-50 px-4 py-3 text-center sm:px-6">
                                    {AddingCar(name, sale_price, year, body_type, engine_type, engine_volume, power, gearbox, type_of_drive, color, mileage, wheel, description, image)}
                                </div>
                            </div>
                        </form>
                    </div>
